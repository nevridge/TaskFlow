...
public class JournalLogEntriesControllerV1Tests
{
    ...
    {
        _controller = new JournalLogEntriesController(_entryRepo.Object, _logRepo.Object, _validator.Object);
    }
    ...
    {
        _entryRepo.Setup(s => s.GetByIdAsync(1)).ReturnsAsync(new JournalEntry { Id = 1, Title = "May 10", Date = new DateOnly(2026, 5, 10) });
